...
export default function SideBar({handleDrawerClose , open , DrawerHeader}) {
  ...
  return (
    <>
        ...
        {/* Avatar */}
        <Avatar
         sx={{mx:"auto" , my: 1 , width: open? 66 : 44, height: open? 66 : 44  , transition:"0.25s"}}
         alt="Manousha" 
         src={img} />

         <Typography sx={{textAlign:"center", fontSize: open ? 17 : 0 ,transition:"0.25s"}}> Menna Ayman </Typography>
         <Typography sx={{textAlign:"center", fontSize: open ? 15 : 0, transition:"0.25s" , color: theme.palette.info.main}}> Admin </Typography> 
         <Divider />
